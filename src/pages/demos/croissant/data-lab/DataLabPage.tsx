...
const ROWS: ReadonlyArray<InventoryRow> = [
  { sku: 'CRO-001', name: 'Classic butter croissant', category: 'pastry', stock: 42, price: 3.5, updated: '2026-05-12' },
  { sku: 'CRO-002', name: 'Almond croissant', category: 'pastry', stock: 18, price: 4.5, updated: '2026-05-12' },
  { sku: 'CRO-003', name: 'Pain au chocolat', category: 'pastry', stock: 31, price: 4.0, updated: '2026-05-12' },
  { sku: 'CRO-004', name: 'Kouign-amann', category: 'pastry', stock: 0, price: 5.0, updated: '2026-05-11' },
  { sku: 'CRO-005', name: 'Cinnamon roll', category: 'pastry', stock: 8, price: 4.25, updated: '2026-05-12' },
  { sku: 'BRD-001', name: 'Country sourdough', category: 'bread', stock: 24, price: 8.0, updated: '2026-05-12' },
  { sku: 'BRD-002', name: 'Whole wheat loaf', category: 'bread', stock: 12, price: 7.0, updated: '2026-05-11' },
  { sku: 'BRD-003', name: 'Baguette', category: 'bread', stock: 36, price: 3.75, updated: '2026-05-12' },
  { sku: 'BRD-004', name: 'Rye loaf', category: 'bread', stock: 4, price: 7.5, updated: '2026-05-11' },
  { sku: 'BRD-005', name: 'Brioche', category: 'bread', stock: 0, price: 6.0, updated: '2026-05-10' },
  { sku: 'BRD-006', name: 'Focaccia', category: 'bread', stock: 14, price: 9.5, updated: '2026-05-12' },
  { sku: 'CAK-001', name: 'Vanilla layer cake', category: 'cake', stock: 6, price: 28.0, updated: '2026-05-11' },
  { sku: 'CAK-002', name: 'Chocolate ganache', category: 'cake', stock: 9, price: 32.0, updated: '2026-05-12' },
  { sku: 'CAK-003', name: 'Lemon tart', category: 'cake', stock: 11, price: 22.0, updated: '2026-05-12' },
  { sku: 'CAK-004', name: 'Carrot cake', category: 'cake', stock: 0, price: 30.0, updated: '2026-05-10' },
  { sku: 'CAK-005', name: 'Cheesecake', category: 'cake', stock: 7, price: 26.0, updated: '2026-05-11' },
  { sku: 'DRK-001', name: 'Espresso', category: 'drink', stock: 999, price: 3.25, updated: '2026-05-12' },
  { sku: 'DRK-002', name: 'Cappuccino', category: 'drink', stock: 999, price: 4.5, updated: '2026-05-12' },
  { sku: 'DRK-003', name: 'Cold brew', category: 'drink', stock: 28, price: 5.0, updated: '2026-05-12' },
  { sku: 'DRK-004', name: 'Hot chocolate', category: 'drink', stock: 16, price: 4.75, updated: '2026-05-11' },
  { sku: 'DRK-005', name: 'Lemonade', category: 'drink', stock: 0, price: 4.0, updated: '2026-05-10' },
  { sku: 'CRO-006', name: 'Ham & cheese croissant', category: 'pastry', stock: 22, price: 5.25, updated: '2026-05-12' },
  { sku: 'CRO-007', name: 'Croissant aux raisins', category: 'pastry', stock: 9, price: 4.25, updated: '2026-05-12' },
  { sku: 'BRD-007', name: 'Bagel', category: 'bread', stock: 30, price: 3.0, updated: '2026-05-12' },
  { sku: 'BRD-008', name: 'Pretzel', category: 'bread', stock: 2, price: 3.5, updated: '2026-05-12' },
];
...
export function DataLabPage() {
  ...
  const filteredData = useMemo(() => {
    ...
    const categories = Array.isArray(categoryFilter?.value)
      ? new Set(categoryFilter.value)
      : null;
      ...
      <Card variant="outlined">
        <CardContent className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <Tabs value={tab} onValueChange={(v) => setTab(v as 'all' | 'low' | 'out')} variant="segmented">
              <TabsList>
